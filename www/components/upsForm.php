<div class="form-group">
    ...
    <select id="printerType-select" onclick="printerType();" class="browser-default custom-select">
        ...
        <option value="Online 10 KVA UPS" selected>Online 10 KVA UPS</option>
        <option value="Online 11 KVA UPS">Online 11 KVA Offline UPS</option>
        <option value="Offline 600 VA UPS">Offline 600 VA UPS</option>
        <option value="Offline 1000 VA UPS">Offline 1000 VA UPS</option>
        <option value="Offline 550 VA UPS">Offline 550 VA UPS</option>
    </select>
</div>
